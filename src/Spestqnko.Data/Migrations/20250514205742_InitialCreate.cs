        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PWSalt = table.Column<byte[]>(type: "bytea", nullable: false),
                    PWHash = table.Column<byte[]>(type: "bytea", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Name = table.Column<string>(type: "text", nullable: false),
                    MaxSpendingAmount = table.Column<float>(type: "real", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserWalletCategories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserWalletCategories_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserWalletCategories_UserWallets_UserWalletId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    UserWalletCategoryId = table.Column<Guid>(type: "uuid", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserWalletCategories_CategoryId",
                table: "UserWalletCategories",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_UserWalletCategories_UserWalletId",
                table: "UserWalletCategories",
                column: "UserWalletId");
